...
export class HomeComponent {
  ...
  recommendedProductsData: UserRecommendations[] = [
    {
      userId: 'user_12345',
      generatedAt: '2025-09-28T15:30:00Z',
      sections: [
        {
          sectionId: 'trending',
          title: 'Trending Now',
          subtitle: 'Popular products everyone is buying',
          type: 'trending',
          showMoreLink: '/trending-products',
          products: [
            {
              id: 'rec_001',
        ...
        {
          sectionId: 'personalized',
          title: 'Recommended for You',
          subtitle: 'Based on your browsing and purchase history',
          type: 'personalized',
          showMoreLink: '/personalized-recommendations',
          products: [
            {
              id: 'rec_003',
        ...
        {
          sectionId: 'frequently_bought',
          title: 'Frequently Bought Together',
          subtitle: 'Customers who bought similar items also purchased',
